      ...
      <main>
        <div className="relative flex min-h-screen flex-col items-center justify-center bg-gray-900 px-4 pb-20">
          <Image
            ...
            height="1080"
          />
          <div className="z-9 absolute bottom-0 top-0 w-full overflow-scroll rounded-xl bg-[#f8f8f2] sm:bottom-2 sm:top-2 sm:w-10/12 md:w-9/12 lg:w-10/12">
            <div className=" z-25 flex items-center justify-center rounded-t-lg border-b-2 border-[#44475a] bg-[#bd93f9] text-center">
            ...
            <div className="flex flex-col gap-6 px-4 lg:flex-row">
              ...
              <div className="w-full rounded-lg bg-white p-6 shadow lg:w-9/12">
                ...
                <p className="pb-4 text-gray-700">
                  With over 3 years of experience as a Digital Product Manager
                  and Electronic Platform Specialist at Nordic-Baltic Support, I
                  have honed my skills in managing digital products and ensuring
                  seamless platform functionality. My prior experience as a Data
                  Entry Specialist at Nordic-Baltic Outsource has provided me
                  with the discipline and attention to detail that is essential
                ...
                <p className="pb-4 text-gray-700">
                  ...
                  technology, allowing me to excel in various roles throughout
                  my career.
                </p>
                <p className="text-gray-700">
                  As a recent graduate of the Baltic Institute of
                  Technology&apos;s FE Developer program, I have gained valuable
                  expertise in Javascript, HTML, CSS, React.js. As a
                  self-motivated and intellectually curious individual, I am
                  eager to leverage my junior-level skills to create innovative
                  web solutions.
                </p>

                <h3 className="-mb-2 mt-3 text-center font-semibold">
                  Find me on
                </h3>
                ...
                <div className="mb-6">
                  ...
                  <ul className="list-disc pl-8">
                    <li>
                      Oversaw the management of various digital products within
                      our ecosystem, the one we developed internally and from
                      partners.
                    </li>
                    <li>
                      Collaborated closely with development teams to
                      continuously enhance our platform&apos;s functionality,
                      actively exploring the possibility of creating a
                      proprietary SaaS solution.
                    </li>
                    <li>
                      Engaged in productive discussions with business clients
                      and customers, gathering requirements, and leveraging
                      digital tools to create impactful marketing campaigns and
                      automation.
                    </li>
                    <li>
                      Demonstrated strong documentation skills, capturing
                      detailed information on all tools and processes while also
                      creating comprehensive learning materials for new team
                      members, fostering knowledge sharing and efficient
                      on-boarding.
                    </li>
                  </ul>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <ul className="list-disc pl-8">
                    <li>
                      ...
                      streamlining the process of receiving and validating
                      product data from sellers on the platform.
                    </li>
                    <li>
                      Implemented templates inspired by industry-leading
                      platforms, such as Amazon, to ensure seamless data
                      validation and accurate allocation to appropriate
                      categories, allowing for manual error resolution when
                      required.
                    </li>
                    <li>
                      Played a critical role in the creation of product
                      management systems, merchandising tools, and an automatic
                      size assignment tool, significantly enhancing overall
                      platform functionality and elevating the customer
                      experience.
                    </li>
                    <li>
                      Facilitated effective communication between internal
                      teams, business clients, and the development team,
                      fostering seamless collaboration and successful project
                      delivery.
                    </li>
                  </ul>
                </div>
                ...
                <div className="mb-12">
                  ...
                  <ul className="list-disc pl-8">
                    <li>
                      Ensured data accuracy and quality control for the
                      e-commerce platform through meticulous review and
                      verification of product information, including images,
                      measurements, descriptions, and links.
                    </li>
                    <li>
                      Offered valuable recommendations to the development teams
                      for automating and streamlining the data entry process,
                      leading to improved efficiency and decreased reliance on
                      manual effort.
                    </li>
                    <li>
