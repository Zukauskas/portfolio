  ...
  return (
    <nav className='bg-white border-gray-200 z-10'>
      <div className='fixed bottom-4 left-1/2 transform -translate-x-1/2 inline-flex mx-auto justify-between bg-[#6272a4] w-11/12 md:w-6/12 xl:w-3/12 rounded-3xl z-10'>
        ...
        <Link
          className={`inline-flex flex-col items-center text-xs font-medium ${pathName === '/projects' ? 'text-white' : 'text-blue-400'} hover:text-white py-3 px-4 pt-4 flex-grow`}
          href='/projects'
        >
          <svg className='w-6 h-6' viewBox='0 0 16 16' xmlns='http://www.w3.org/2000/svg' fill='currentColor'> <path d='M3.994 1c-1.258.015-2.179-.029-2.931.387a1.878 1.878 0 0 0-.84.996C.058 2.82 0 3.343 0 4v8c0 .658.058 1.179.223 1.617.164.439.463.79.84.998.752.416 1.673.37 2.931.385h8.012c1.258-.015 2.179.03 2.932-.385.376-.207.675-.56.84-.998.164-.438.222-.96.222-1.617V6c0-.658-.058-1.179-.223-1.617-.02-.055-.048-.104-.074-.154l-.027-.057a1.838 1.838 0 0 0-.738-.787c-.753-.416-1.674-.37-2.932-.385H8.967L6.945 1H3.996zm.012 1h2.53L8.3 3.746 7.033 5H3.994c-1.258.015-2.179-.03-2.932.385-.022.012-.04.03-.062.043V4c0-.592.062-1.006.16-1.266s.203-.371.387-.472c.366-.203 1.195-.247 2.459-.262zm5.459 2h2.527c1.264.015 2.092.06 2.46.262.183.1.288.212.386.472.098.26.162.674.162 1.266v6c0 .592-.063 1.006-.16 1.266-.098.26-.203.371-.387.472-.366.202-1.193.247-2.453.262H4c-1.26-.015-2.087-.06-2.453-.262-.184-.1-.29-.212-.387-.472C1.063 13.006 1 12.592 1 12V8c0-.592.064-1.006.162-1.266s.203-.371.387-.472c.367-.203 1.195-.247 2.459-.262h3.435z' fill='currentColor' /></svg>
        ...
        <Link
          ...
          href='#'
        >
          <svg className='w-7 h-7' version='1.1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' fill='currentColor'>
